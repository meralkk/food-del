...
// category and setCategory props are coming from Home page 
    ...
    <div className='explore-menu' id='explore-menu'>
        ...
        <div className="explore-menu-list">
            {menu_list.map((item,index)=>{
                return (
                     // When a menu item is clicked, the setCategory function is called to switch to a specific category.
